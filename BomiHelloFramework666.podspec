#
#  Be sure to run `pod spec lint BomiHelloFramework666.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/mik-fungmae/BomiHelloFramework.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "BomiHelloFramework/**/*.{h,m}"
